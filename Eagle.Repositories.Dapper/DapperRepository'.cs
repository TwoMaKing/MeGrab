...
{
    public abstract class DapperRepository<TAggregateRoot, TIdentityKey> : Repository<TAggregateRoot, TIdentityKey> where TAggregateRoot : class, IAggregateRoot<TIdentityKey>, new()
    {
        private IDapperRepositoryContext dapperRepositoryContext;

        public DapperRepository(IRepositoryContext repositoryContext)
