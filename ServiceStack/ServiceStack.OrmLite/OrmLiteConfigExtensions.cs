...
namespace ServiceStack.OrmLite
{
    internal static class OrmLiteConfigExtensions
    {
        ...
        internal static ModelDefinition GetModelDefinition(this Type modelType)
        {
            ...
            PropertyInfo tablePrimaryPropertyInfo = null;
            ...
            {
                tablePrimaryPropertyInfo = objProperties.SingleOrDefault(p => p.Name.Equals(tablePrimaryKey.PrimaryKey));
                hasTablePrimaryKey = tablePrimaryPropertyInfo != null;
                primaryKeyReferencesType = tablePrimaryKey.ReferencesType;
            }
            ...
            foreach (var propertyInfo in objProperties)
            {
                ...
                var isPropertyFromTablePrimaryKey = hasTablePrimaryKey && 
                                                    propertyInfo.Name.Equals(tablePrimaryPropertyInfo.Name);

                var isPrimaryKey =  isPropertyFromTablePrimaryKey
                ...
                var fieldDefinition = new FieldDefinition
                {
                    ...
                    AutoIncrement =
                        ...
                        (isPropertyFromTablePrimaryKey &&
                         tablePrimaryKey.AutoIncrement)),
                    ...
                    ForeignKey = isPropertyFromTablePrimaryKey && 
                                 primaryKeyReferencesType != null ?
                                 new ForeignKeyConstraint(primaryKeyReferencesType) :
                ...
                var isIgnored = (ignoreColumns != null &&
                                 ignoreColumns.Contains(propertyInfo.Name))
                                 || propertyInfo.HasAttributeNamed(typeof(IgnoreAttribute).Name)
